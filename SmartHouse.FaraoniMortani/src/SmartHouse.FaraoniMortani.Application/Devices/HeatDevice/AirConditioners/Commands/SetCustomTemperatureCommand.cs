...
{
    public class SetCustomTemperatureCommand
    {
        private readonly IAirConditionerRepository _airConditionerRepository;

        public SetCustomTemperatureCommand(IAirConditionerRepository airConditionerRepository)
        {
        ...
        public void Execute(Guid id, double newtemp)
        {
            ...
            {
                airConditioner.SetCustomTemperature(newtemp);
